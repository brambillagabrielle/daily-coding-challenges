...
def launch_fuel(payload):
    ...
    return round(total_mass, 1)

print("Success") if launch_fuel(50) == 12.4 else print("Failed")
print("Success") if launch_fuel(500) == 124.8 else print("Failed")
print("Success") if launch_fuel(243) == 60.7 else print("Failed")
print("Success") if launch_fuel(11000) == 2749.8 else print("Failed")
print("Success") if launch_fuel(6214) == 1553.4 else print("Failed")